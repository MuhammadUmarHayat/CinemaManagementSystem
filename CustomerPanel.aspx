<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerPanel.aspx.cs" Inherits="Cinema_Management_System.CustomerPanel" %>
...
<br /><br /><br />
              <asp:Label ID="Label2" runat="server" style="font-weight: 700; color: #9900FF; font-size: large" Text="Label"></asp:Label>
              <br /><br /><br />
            ...
            <table class="auto-style1" align="center">
                <tr>
                    <td>Name</td>
                    <td>
                        <asp:Label ID="lblName" runat="server" style="color: #CC00CC; font-weight: 700"></asp:Label>
                    </td>
                    <td>Ticket Type</td>
                    <td>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SeemabFDBConnectionString %>" SelectCommand="SELECT DISTINCT [type] FROM [tickets]"></asp:SqlDataSource>
                        <asp:Button ID="btn2" runat="server" OnClick="btn2_Click" Text="Next" CausesValidation="False" />
                    </td>
                </tr>
                <tr>
                    <td class="auto-style3">CNIC</td>
                    <td class="auto-style3">
                        <asp:Label ID="lblCNIC" runat="server" style="font-weight: 700; color: #339966"></asp:Label>
                    </td>
                    <td class="auto-style3">Price</td>
                    <td class="auto-style3">
                        <asp:Label ID="lblTicketPrice" runat="server" style="font-weight: 700; font-style: italic" CssClass="auto-style4"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>Mobile Number</td>
                    <td>
                        <asp:Label ID="lblMob" runat="server" style="color: #0000CC; font-weight: 700"></asp:Label>
                    </td>
                    <td>Total seats</td>
                    <td>
