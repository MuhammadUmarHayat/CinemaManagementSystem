...
namespace Cinema_Management_System
{
    public partial class CustomerPanel : System.Web.UI.Page
    {
            ...
            private void showCustomerInformation(string email)
            {
                string userEmail = email;
                DAL dal = new DAL();
                DataTable dt = dal.show("users", "email", userEmail);
                if (dt.Rows.Count > 0)
                {
            ...
            protected void btnBookNow_Click(object sender, EventArgs e)
            {
                ...
                string[] sar = { name, cnic, mobileNo, theatre, ShowTime, ShowDate, movieName, TicketType, price, totalSeats, isMember, seatNumbers, TotalPayment, ReservationDate };
